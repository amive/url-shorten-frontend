    ...
    data.forEach((shortUrl) => {
      ...
      li.innerHTML = `
        ...
        <div class="shorten-url__actions hidden">
            ...
            <button class="update-btn hidden" onclick="updateShortUrl('${
              shortUrl.id
            }')">Update</button>
            <button class="delete-btn hidden" onclick="deleteShortUrl('${
              shortUrl.id
            }')"><img src="path/to/delete-icon.png" alt="Delete" /></button>
        </div>
      `;
